 ...
 * Subject: Project 2.
 * Date: 30/10/2015
 * Description: Class that enables Metaio SDK and retrieves Title.html
 */
...
import olveston.augmented.reality.BuildConfig;
	...
	private class AssetsExtracter extends AsyncTask<Integer, Integer, Boolean>
	{
		...
		protected void onPostExecute(Boolean result) 
		{
			...
			if (result)
			{
				...
				mWebView.loadUrl("file:///android_asset/Menu/Title.html");
